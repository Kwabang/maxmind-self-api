...
const asn = (query_ip) => {
  return new Promise(async (resolve, reject) => {
    let asn_data;
    try {
      asn_data = (await maxmind.open("./database/GeoLite2-ASN.mmdb")).get(
        query_ip
      );
    } catch (err) {
      reject(err);
...
const country = (query_ip) => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      country_data = (
        await maxmind.open("./database/GeoLite2-Country.mmdb")
      ).get(query_ip);
    } catch (err) {
      reject(err);
    }
...
const city = (query_ip) => {
  return new Promise(async (resolve, reject) => {
    let city_data;
    try {
      city_data = (await maxmind.open("./database/GeoLite2-City.mmdb")).get(
        query_ip
      );
    } catch (err) {
      reject(err);
...
const geolocation = (query_ip) => {
  return new Promise(async (resolve, reject) => {
    ...
    console.log(asn_data, city_data);
